...
|*| DEFINES IS__TOKEN_PASTING__SUPPORTED IF THE COMPILER SUPPORTS THE TOKEN  |*|
|*| PASTING (##) FEATURE.                                                    |*|
|*|__________________________________________________________________________|*|
|*                                                                            *|
\******************************************************************************/
...
|*| CONTENT                                                       | DOC LINE |*|
|*|===============================================================|==========|*|
|*| #define IS__TOKEN_PASTING__SUPPORTED                          | 36       |*|
...
|* :  v [C LANGUAGE]                                                        : *|
|* : 1|                                                                     : *|
|* : 2| #define IS__TOKEN_PASTING__SUPPORTED                                : *|
|* : 3|                                                                     : *|
|* :                             __                                         : *|
|* : TOKEN PASTING REFERS TO THE ## OPERATOR IN MACROS, USED TO MERGE TWO   : *|
|* : TOKENS INTO ONE DURING PREPROCESSING.                                  : *|
|* :                                                                        : *|
|* : EXAMPLE:                                                               : *|
|* :                                                                        : *|
|* :  v [C LANGUAGE]                                                        : *|
...
|* : 2| #define AB(A, B) A##B                                               : *|
|* : 3|                                                                     : *|
|* : 4| int AB(ma, in)(void) // Expands to: int main(void)                  : *|
|* : 5| {                                                                   : *|
|* : 6|     . . .                                                           : *|
|* : 7| }                                                                   : *|
|* : 8|                                                                     : *|
...
#define CHECK_FEATURE__TOKEN_PASTING_H 202606 /* VERSION */
